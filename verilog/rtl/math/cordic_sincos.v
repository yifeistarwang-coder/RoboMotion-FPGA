...
module cordic_sincos(
	...
	assign cos = cos_flag ? -Xn[16] : Xn[16];
	assign sin = sin_flag ? -Yn[16] : Yn[16];
	...
	begin
		...
		begin
			if(theta >= 32'd5898240 && theta <= 32'd11796480)  //90°<= theta <= 180°
			begin
				Zn[0] <= 32'd11796480 - theta;  // 180 - theta
				cos_flag <= 1'b1;
				sin_flag <= 1'b0;
			end
			else if(theta >= -32'd11796480 && theta <= -32'd5898240) //-180°<= theta <= -90°
			begin
				Zn[0] <= 32'd11796480 + theta;  // 180 + theta
				cos_flag <= 1'b1;
				sin_flag <= 1'b1;
