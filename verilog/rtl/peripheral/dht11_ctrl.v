module dht11_ctrl(
	...
	parameter   T_1S_DATA    = 666_666 ; //1s时间计数值
	parameter   T_18MS_DATA  = 11999  ; //18ms时间计数值
	...
	always@(posedge clk_1us or  negedge sys_rst_n)
		if(sys_rst_n == 1'b0)
			...
			data_out    <=  {data_H2,data_H1,data_T2,data_T1};
	
	
	
	assign data_H2 = data[31:24]/10;
	assign data_H1 = data[31:24]%10;
	assign data_T2 = data[15:8]/10;
	assign data_T1 = data[15:8]%10;
	
	
endmodule    //dht11_ctrl
